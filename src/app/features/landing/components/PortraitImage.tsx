...
export default function PortraitImage() {
  ...
  return (
    <MediaImage
      ...
      imageClassName="object-cover object-[center_20%] md:object-[center_25%] portrait-mask brightness-100 transition-all duration-700 group-hover:brightness-105 group-hover:scale-105"
      fallback={
        <div

            ...
            <div className="flex items-center justify-center gap-4">
              {Social.Github && (
                <a
                  ...
                  className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-primary hover:bg-primary hover:text-background transition-all duration-300"
                >

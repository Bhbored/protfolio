...
import TechnologiesList from "../features/projects/components/TechnologiesList"
import KeyFeaturesList from "../features/projects/components/KeyFeaturesList"
        ...
        <div className="max-w-screen-xl mx-auto">
          ...
          <div className="flex flex-wrap gap-4 md:gap-6 pb-8 border-b border-white/10">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-label text-xs uppercase tracking-widest text-primary">Category</p>
                <p className="font-body text-sm text-on-surface-variant">{getProjectCategoryName(project.ProjectCategory)}</p>
              </div>
            </div>
            ...
            {project.Technologies.length > 0 && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-label text-xs uppercase tracking-widest text-primary">Tech Stack</p>
                  <p className="font-body text-sm text-on-surface-variant">{project.Technologies.length} Technologies</p>
                </div>
              </div>
            )}
            ...
            {project.GithubUrl && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-label text-xs uppercase tracking-widest text-primary">Repository</p>
                  <a href={project.GithubUrl} target="_blank" rel="noopener noreferrer" className="font-body text-sm text-on-surface-variant hover:text-primary transition-colors hover:underline">
                    View on GitHub
                  </a>
                </div>
              </div>
            ...
            {project.LiveUrl && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-label text-xs uppercase tracking-widest text-primary">Live Demo</p>
                  <a href={project.LiveUrl} target="_blank" rel="noopener noreferrer" className="font-body text-sm text-on-surface-variant hover:text-primary transition-colors hover:underline">
                    Visit Site
                  </a>
                </div>
              </div>
        ...
        <div className="max-w-screen-xl mx-auto">
          ...
          {project.Screenshots.length > 0 && (
            <div className="mb-16 md:mb-24">
              ...
              <ScreenshotGallery screenshots={project.Screenshots} isMobileApp={isMobileApp} />
            </div>
          )}
